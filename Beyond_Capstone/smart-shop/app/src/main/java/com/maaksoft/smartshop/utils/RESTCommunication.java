package com.maaksoft.smartshop.utils;
...
public final class RESTCommunication {
    ...
    public static String postPayload(Uri uri, String authorizationHeader, String postPayload) throws IOException {

        System.out.println("REST URI: " + uri);
        System.out.println("Authorization Header: " + authorizationHeader);

        HttpPost httpPost = new HttpPost(uri.toString());
        if (authorizationHeader != null && !(authorizationHeader = authorizationHeader.trim()).isEmpty()) {
            httpPost.setHeader("Authorization", ("key=" + authorizationHeader));
        }
    ...
    public static String postPayload(Uri uri, String postPayload) throws IOException {
        return postPayload(uri, null, postPayload);
    }
